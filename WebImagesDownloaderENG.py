...
def descargar_imagenes(url):
    try:
        ...
        directorio = os.path.join(os.getcwd(), 'Downloaded Images', base_dir)
        ...
        if not imagenes:
            print("No images were found on the website.")
            return
        ...
        print("An error occurred while downloading the images:", str(e))
